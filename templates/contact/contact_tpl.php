                ...
                <form class="contact-form validation-contact col-lg-6" novalidate method="post" action=""
                    ...
                    <div class="form-row">
                        ...
                        <div class="contact-input col-sm-6">
                            <input type="email" class="form-control text-sm" id="email-contact"
                                name="dataContact[email]" placeholder="Email" value="<?= $flash->get('email') ?>"
                                required />
                    ...
                    <div class="contact-input">
                        ...
                        <label class="custom-file-label" for="file_attach"
                            title="<?= chon ?>"><?= dinhkemtaptin ?></label>
                    </div>
