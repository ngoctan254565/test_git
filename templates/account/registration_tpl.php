            ...
            <form class="form-user validation-user" novalidate method="post" action="account/dang-ky"
                ...
                <div class="input-group input-user">
                    ...
                    <input type="text" class="form-control text-sm" id="fullname" name="fullname"
                        placeholder="<?= nhaphoten ?>" value="<?= $flash->get('fullname') ?>" required>
                ...
                <div class="input-group input-user">
                    ...
                    <input type="text" class="form-control text-sm" id="username" name="username"
                        placeholder="<?= nhaptaikhoan ?>" value="<?= $flash->get('username') ?>" required>
                ...
                <div class="input-group input-user">
                    ...
                    <input type="password" class="form-control text-sm" id="password" name="password"
                        placeholder="<?= nhapmatkhau ?>" required>
                ...
                <div class="input-group input-user">
                    ...
                    <input type="password" class="form-control text-sm" id="repassword" name="repassword"
                        placeholder="<?= nhaplaimatkhau ?>" required>
                ...
                <div class="input-group input-user">
                    ...
                    <input type="text" class="form-control text-sm" id="birthday" name="birthday"
                        placeholder="<?= nhapngaysinh ?>" value="<?= $flash->get('birthday') ?>" required
                        autocomplete="off">
                ...
                <div class="input-group input-user">
                    ...
                    <input type="email" class="form-control text-sm" id="email" name="email"
                        placeholder="<?= nhapemail ?>" value="<?= $flash->get('email') ?>" required>
                ...
                <div class="input-group input-user">
                    ...
                    <input type="number" class="form-control text-sm" id="phone" name="phone"
                        placeholder="<?= nhapdienthoai ?>" value="<?= $flash->get('phone') ?>" required>
                    <div class="invalid-feedback"><?= vuilongnhapsodienthoai ?></div>
                </div>
                <label><?= diachi ?></label>
                <div class="input-group input-user">
                    ...
                    <input type="text" class="form-control text-sm" id="address" name="address"
                        placeholder="<?= nhapdiachi ?>" value="<?= $flash->get('address') ?>" required>
                    <div class="invalid-feedback"><?= vuilongnhapdiachi ?></div>
                </div>
                <div class="button-user">
                    <input type="submit" class="btn btn-primary btn-block" name="registration-user"
                        value="<?= dangky ?>" disabled>
                </div>
            </form>
        </div>
    </div>
