                    ...
                    <div class="top-cart col-12 col-lg-7">
                        ...
                        <div class="money-procart">
                            ...
                            <div class="total-procart d-flex align-items-center justify-content-between">
                                <p><?= tamtinh ?>:</p>
                                <p class="total-price load-price-temp"><?= $func->formatMoney($cart->getOrderTotal()) ?>
                                </p>
                            </div>
                            <?php } ?>
                            <?php if ($config['order']['ship']) { ?>
                            ...
                            <div class="total-procart d-flex align-items-center justify-content-between">
                                ...
                                <p class="total-price load-price-total">
                                    <?= $func->formatMoney($cart->getOrderTotal()) ?></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="information-cart">
                                <div class="form-row">
                                    ...
                                    <div class="input-cart col-md-6">
                                        <input type="number" class="form-control text-sm" id="phone"
                                            name="dataOrder[phone]" placeholder="<?= sodienthoai ?>"
                                ...
                                <div class="input-cart">
                                    <input type="text" class="form-control text-sm" id="address"
                                        name="dataOrder[address]" placeholder="<?= diachi ?>"
