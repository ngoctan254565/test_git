...
function saveMan()
{
	...
	if ($data) {
		...
		$data['type'] = $type;
		$data['price_from'] = (isset($data['price_from']) && $data['price_from'] != '') ? str_replace(",", "", $data['price_from']) : 0;
		$data['price_to'] = (isset($data['price_to']) && $data['price_to'] != '') ? str_replace(",", "", $data['price_to']) : 0;
		$data['time_from'] = (isset($data['time_from']) && $data['time_from'] != '') ? strtotime($data['time_from']) : '';
		$data['time_to'] = (isset($data['time_to']) && $data['time_to'] != '') ? strtotime($data['time_to']) : '';
	}
