                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['news'][$type]['job']) && $config['news'][$type]['job'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="job<?= $k ?>">Nghề nghiệp (<?= $k ?>):</label>
                                                    <input type="text" class="form-control  text-sm" name="data[job<?= $k ?>]" id="job<?= $k ?>" placeholder="Nghề nghiệp (<?= $k ?>)" value="<?= (!empty($flash->has('job' . $k))) ? $flash->get('job' . $k) : @$item['job' . $k] ?>">
                                                </div>
                                            <?php } ?>
                                ...
                                <div class="row">
                                    <?php if (isset($config['news'][$type]['video']) && $config['news'][$type]['video'] == true) { ?>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control text-sm" name="data[video]" id="video" placeholder="Video" value="<?= (!empty($flash->has('video'))) ? $flash->get('video') : @$item['video'] ?>">
                                        </div>
                                    <?php } ?>

                                    <?php if (isset($config['news'][$type]['price']) && $config['news'][$type]['price'] == true) { ?>
                                        <div class="form-group col-md-6">
                                            <label class="d-block" for="price_from">Giá từ:</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control format-price price_from text-sm" name="data[price_from]" id="price_from" placeholder="Giá bán" value="<?= (!empty($flash->has('price_from'))) ? $flash->get('price_from') : @$item['price_from'] ?>">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="d-block" for="price_to">Giá đến:</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control format-price price_to text-sm" name="data[price_to]" id="price_to" placeholder="Giá bán" value="<?= (!empty($flash->has('price_to'))) ? $flash->get('price_to') : @$item['price_to'] ?>">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                                </div>
                                            </div>
                                    ...
                                    <?php if (isset($config['news'][$type]['time']) && $config['news'][$type]['time'] == true) { ?>
                                        <div class="form-group col-md-6">
                                            <label class="d-block" for="time_from">Thời gian từ:</label>
                                            <div class="input-group">
                                                <input type="text" class="time form-control  time_from text-sm" name="data[time_from]" id="time_from" placeholder="Thời gian từ" value="<?= (@$item['time_from'] == '') ? '' : date('d-m-Y H:i', @$item['time_from']) ?>">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="d-block" for="time_to">Thời gian đến:</label>
                                            <div class="input-group">
                                                <input type="text" class="time form-control  time_to text-sm" name="data[time_to]" id="time_to" placeholder="Thời gian đến" value="<?= (@$item['time_to'] == '') ? '' : date('d-m-Y H:i', @$item['time_to']) ?>">
                                                <div class="input-group-append">
                                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                                </div>
                                            </div>
