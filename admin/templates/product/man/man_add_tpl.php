                        ...
                        <div class="card-body">
                            <div class="form-group-category row">
                                ...
                                <?php if (isset($config['product'][$type]['brand']) && $config['product'][$type]['brand'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        <label class="d-block" for="id_brand">Thương hiệu:</label>
                                        <?= $func->getAjaxCategory('product', 'brand', $type, 'Chọn thương hiệu') ?>
                                    </div>
                                <?php } ?>
                                ...
                                <?php } ?>
                                <?php if (isset($config['product'][$type]['sale']) && $config['product'][$type]['sale'] == true) { ?>
                                    <div class="form-group col-xl-12 col-sm-12">
                                        <label class="d-block" for="id_sale">Danh mục flash sale:</label>
                                        <?= $func->getSale(@$item['id'], 'id_sale', 'product', 'tags-sale') ?>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (
                                    isset($config['product'][$type]['color']) && $config['product'][$type]['color'] == true && isset($config['product'][$type]['size']) && $config['product'][$type]['size'] == true

                                ) { ?>

                                    <div class="form-group-attrs col-12">

                                        <div class="group-attrs row">

                                            <?php if (!empty($tt) &&  !empty($item['id'])) {
                                                foreach ($tt as $tt) {
                                                    $size = $d->rawQueryOne("select id, namevi from #_size where id = ?  limit 0,1", array($tt['id_size']));
                                                    $color = $d->rawQueryOne("select id, namevi from #_color where id = ?  limit 0,1", array($tt['id_color']));
                                            ...
                                            ?>
                                                    ...
                                                    <div class="form-group col-xl-12 col-lg-4 col-md-4 col-sm-6">
                                                        ...
                                                        <label>
                                                            ...
                                                            <span class="text-danger"><?= $color['namevi'] ?></span>

                                                            <span> - </span>

                                                            <span>Kích thước: </span>

                                                            <span class="text-danger"><?= $size['namevi'] ?></span>

                                                        </label>

                                                        <div class="input-group">

                                                            <input type="text" class="form-control format-price price-origin-attr" name="price_attrs[regular_price][]" placeholder="Giá bán" value="<?= @$tt['regular_price'] ?>">
                                                        ...
                                                        <input type="hidden" name="price_attrs[id_color][]" value="<?= $color['id'] ?>" />

                                                        <input type="hidden" name="price_attrs[id_size][]" value="<?= $size['id'] ?>" />
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['product'][$type]['old_price']) && $config['product'][$type]['old_price'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label class="d-block" for="old_price">Giá cũ:</label>
                            <div class="input-group">
                                <input type="text" class="form-control format-price old_price text-sm" name="data[old_price]" id="old_price" placeholder="Giá cũ" value="<?= (!empty($flash->has('old_price'))) ? $flash->get('old_price') : @$item['old_price'] ?>">
                                <div class="input-group-append">
                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                </div>
                            </div>
                    ...
                    <?php if (isset($config['product'][$type]['time']) && $config['product'][$type]['time'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label class="d-block" for="time">Thời gian (Phút):</label>
                            <input type="text" class="form-control text-sm" name="data[time]" id="time" placeholder="Thời gian (Phút)" value="<?= (!empty($flash->has('time'))) ? $flash->get('time') : @$item['time'] ?>">
                        </div>
                    <?php } ?>
