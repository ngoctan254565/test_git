...
$requick = array(
	...
	array("tbl" => "news", "field" => "id", "source" => "news", "com" => "vi-sao-chon-chung-toi", "type" => "vi-sao-chon-chung-toi", "menu" => true),
...
switch ($com) {
	...
	case 'vi-sao-chon-chung-toi':
		$source = "news";
		$template = isset($_GET['id']) ? "news/news_detail" : "news/news";
		$seo->set('type', isset($_GET['id']) ? "article" : "object");
		$type = $com;
		$titleMain = "Vì sao chọn chúng tôi";
		break;
